...
all_post_test_full_trim_inf_hist <- vector(mode = "list", length = 4)
samp_no_list <- vector(mode = "list", length = 4)
for (p in 1:4) { 
...
save(post_full, file = here::here("outputs", "hcw_pre", "fits", "dis_dep", "cross_sec", "trimmed_post_full.Rdata"))
