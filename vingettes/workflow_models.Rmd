...
all_models_hcw_pre_test <- all_models_hcw_pre_cross
...
all_models_hcw_pre_test <- all_models_hcw_pre_full
all_post_test <- all_models_hcw_pre_test %>%
    map(~load_mcmc_post(.x,
        fit_place = "local",
        folder_name_1 = "dis_dep",
...
purrr::map2(all_post_test, all_models_hcw_pre_test, ~plot_traces(.x, .y, file = "dis_dep/full"))
purrr::map2(all_post_test, all_models_hcw_pre_test, ~plot_titre_post(.x, .y, file = "dis_dep/full"))
