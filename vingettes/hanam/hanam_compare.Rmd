...
load(file = here::here("outputs", "hanam", "fits", "dis_dep", "full", "trimmed_post_full.Rdata"))
...
titre_dat <- all_models_hanam_cross[[2]]$create_post$titre_data
vaccination_histories <- all_models_hanam_cross[[2]]$create_post$vaccination_histories

antigenic_map <- all_models_hanam_cross[[2]]$create_post$antigenic_map
strain_isolation_times <-  all_models_hanam_cross[[2]]$create_post$strain_isolation_times
par_tab <- all_models_hanam_cross[[2]]$create_post$par_tab

vaccination_histories <- all_models_hanam_cross[[2]]$create_post$vac_history
custom_ab_kin_func <- all_models_hanam_cross[[2]]$custom_ab_kin_func
custom_ab_kin_func_1 <- all_models_hanam_cross[[2]]$custom_ab_kin_func

custom_antigenic_maps_func <- all_models_hanam_cross[[2]]$custom_antigenic_maps_func
