get_model_info_hcw_pre <- function(study) {
    ...
    par_tab_vac <-  rbind(par_tab,
            ...
            list("tau_prev_vac", 1, 1, 0.1,  0, 1,  0.01, 0.1, 1),
            list("sigma1_vac",   1, 1, 0.1, 0, 5,  0, 1, 1),
    ...
    save(all_models_hcw_pre, file = here::here("data", paste0("modelinfo_", study$study_name_short, ".RDS")))
}
